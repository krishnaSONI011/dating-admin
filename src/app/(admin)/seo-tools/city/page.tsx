...
export default function City() {
    ...
    async function handleDelete(id: string) {
        ...
        try {
            ...
            const res = await api.post('/Wb/delete_city', formData)
    ...
    return (
        <div className="rounded-2xl border border-gray-800 bg-[#020617] p-6 shadow-xl text-white">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    onClick={() => router.push("/seo-tools/city/add")}
    ...
    <input
        ...
        className="w-full md:w-80 bg-gray-900 border border-gray-700 p-2 rounded"
    />
</div>
            {/* TABLE */}
                            ...
                            filteredCities.map((state, index) => (
                                ...
                                >
                                    ...
                                    <td className="p-3 text-center space-x-2">
                                        <button
                                            onClick={() => router.push(`/seo-tools/city/edit/${state.id}`)}
